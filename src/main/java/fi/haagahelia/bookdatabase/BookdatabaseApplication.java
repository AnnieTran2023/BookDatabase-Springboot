...
public class BookdatabaseApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository, CategoryRepository crepository,
		...
		return (args) -> {
			...
			// Book book1 = new Book("JK Rowling", "Harry Potter", "978-1-4088-1234-5",
			// 2023, fiction);
			// Book book2 = new Book("Isaac Asimov", "Foundation", "978-0-553-08002-7",
			// 2021, scienceFiction);
			// Book book3 = new Book("Agatha Christie", "Murder on the Orient Express",
			// "978-0-06-207350-1", 2020,
			// mystery);
			// Book book4 = new Book("George R.R. Martin", "A Game of Thrones",
			// "978-0-553-10354-0", 1999, fiction);
